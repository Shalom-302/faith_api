...
# --- Domaine Faith Social ---
from app.routers import sermons as faith_sermons
from app.routers import testimonies as faith_testimonies
from app.routers import questions as faith_questions
from app.routers import social as faith_social
from app.routers import messages as faith_messages
from app.routers import admin as faith_admin
...
def on_startup():
    ...
    # Initialisation du domaine Faith Social (tables faith_* + rôles métier)
    init_faith()
...
# --- Domaine Faith Social ---
api_router.include_router(faith_sermons.router, prefix="/sermons", tags=["Faith - Sermons"])
api_router.include_router(faith_testimonies.router, prefix="/testimonies", tags=["Faith - Témoignages"])
api_router.include_router(faith_questions.router, prefix="/questions", tags=["Faith - Questions"])
api_router.include_router(faith_social.router, prefix="/social", tags=["Faith - Social"])
api_router.include_router(faith_messages.router, prefix="/messages", tags=["Faith - Messagerie"])
api_router.include_router(faith_admin.router, prefix="/admin", tags=["Faith - Administration"])
