...
class UserInDB(UserBase):
    ...
    # Override : sur une réponse, l'email vient de la base et est déjà fiable.
    # On évite `EmailStr` qui rejette les TLD réservés (ex. `.test`, RFC 2606)
    # et ferait planter la sérialisation (`/auth/me`) pour les comptes de démo.
    email: str
    id: uuid.UUID
    is_verified: bool
    is_superuser: bool
